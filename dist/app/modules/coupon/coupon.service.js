...
//get all coupon
const getAllCoupons = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
//update coupon
const updateCoupon = (id, props) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const coupon = yield coupon_models_1.Coupon.findByIdAndUpdate(id, props, {
      new: true,
    });
    if (!coupon) {
      throw new api_error_1.default(
