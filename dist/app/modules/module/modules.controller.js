...
//get all modules
const getAllModules = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      modules_constants_1.ModuleFilterableFields,
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields,
    );
    const result = yield modules_service_1.ModuleService.getAllModules(
      filters,
      paginationOptions,
    );
    (0, sendResponse_1.default)(res, {
...
//get modules by id
const getModuleById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateModule = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield modules_service_1.ModuleService.updateModules(
      id,
      updatedData,
    );
    (0, sendResponse_1.default)(res, {
