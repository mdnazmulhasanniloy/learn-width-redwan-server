...
router.post(
  ...
  (0, validateRequest_1.default)(
    modules_validation_1.moduleValidations.createModuleZodSchema,
  ),
  modules_controller_1.ModuleController.createModule,
);
router.patch(
  '/:id',
  (0, validateRequest_1.default)(
    modules_validation_1.moduleValidations.updateModuleZodSchema,
  ),
  modules_controller_1.ModuleController.updateModule,
);
