...
//get all batch
const getAllBatches = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (searchTerm) {
      andCondition.push({
        $or: batch_constants_1.batchSearchableFields
          .map(field => ({
            [field]: {
              $regex: searchTerm,
              $options: 'i',
...
//update a batch
const updateBatch = (id, props) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield batch_models_1.Batch.findByIdAndUpdate(id, props, {
      new: true,
    });
    if (!result) {
      throw new api_error_1.default(
