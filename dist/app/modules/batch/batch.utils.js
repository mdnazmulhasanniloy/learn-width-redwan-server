...
const findLastBatchId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastBatchId = yield batch_models_1.Batch.findOne()
      .sort({ createdAt: -1 })
      .lean();
    return (
      lastBatchId === null || lastBatchId === void 0 ? void 0 : lastBatchId.id
    )
      ? lastBatchId === null || lastBatchId === void 0
        ? void 0
...
const generateBatchId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentId =
      (yield (0, exports.findLastBatchId)()) || (0).toString().padStart(5, '0');
    //increment by 1
