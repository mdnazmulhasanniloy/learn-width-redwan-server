...
const createBatch = (0, catchAsync_1.default)((req, res) =>
...
//get all batch
const getAllBatch = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      batch_constants_1.batchFilterableFields,
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields,
    );
    const result = yield batch_service_1.BatchService.getAllBatches(
      filters,
      paginationOptions,
    );
    (0, sendResponse_1.default)(res, {
...
//get batch by id
const getBatchById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
//update batch
const updateBatch = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updatedData = req === null || req === void 0 ? void 0 : req.body;
    const result = yield batch_service_1.BatchService.updateBatch(
      id,
      updatedData,
    );
    (0, sendResponse_1.default)(res, {
...
//delete batch
const deleteBatch = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const id =
