...
router.post('/create-batch', (0, validateRequest_1.default)(batch_validation_1.batchValidation.createBatchZodSchema), batch_controller_1.BatchController.createBatch);
router.patch('/:id', (0, validateRequest_1.default)(batch_validation_1.batchValidation.updateBatchZodSchema), batch_controller_1.BatchController.updateBatch);
