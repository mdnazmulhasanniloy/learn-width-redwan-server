...
const findLastCourseId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastCourseId = yield course_models_1.Course.findOne().sort({ createdAt: -1 }).lean();
    return (lastCourseId === null || lastCourseId === void 0 ? void 0 : lastCourseId.id)
        ? lastCourseId === null || lastCourseId === void 0 ? void 0 : lastCourseId.id.substring(2)
