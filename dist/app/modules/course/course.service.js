...
//get all course
const getAllCourses = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
const updateCourse = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield course_models_1.Course.findByIdAndUpdate(id, props, {
      new: true,
    });
    if (!result) {
      throw new api_error_1.default(
...
const deleteCourse = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, s3_1.deleteFromS3)(
      `images/courses/${course === null || course === void 0 ? void 0 : course.id}`,
    );
