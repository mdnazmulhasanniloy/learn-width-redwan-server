...
const createCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { file } = req;
    const course = Object.assign({}, req === null || req === void 0 ? void 0 : req.body);
    const result = yield course_service_1.CourseService.createCourse(course, file);
...
const updateCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { file } = req;
    const updatedData = Object.assign({}, req === null || req === void 0 ? void 0 : req.body);
    const result = yield course_service_1.CourseService.updateCourse(id, updatedData, file);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
