...
//create lecture
const createLecture = (props) => __awaiter(void 0, void 0, void 0, function* () {
    // auto generated incremental id
    const courseId = yield (0, lecture_utils_1.generateLectureId)();
    props.id = courseId;
    const result = yield lecture_models_1.Lecture.create(props);
    if (!result) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! lecture creation is Failed');
    }
    return result;
});
//get all lecture
const getAllLectures = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const result = yield lecture_models_1.Lecture.find(whereCondition)
        ...
        .limit(limit);
    if (!result) {
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, 'oops! lecture is not found.');
    }
...
//update lecture
const updateLecture = (id, props) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield lecture_models_1.Lecture.findByIdAndUpdate(id, props, { new: true });
    if (!result) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! lecture update is Failed');
    }
    return result;
});
//delete lecture
const deleteLecture = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! lecture delete is Failed');
    }
    return result;
});
