...
const initPayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!paymentSession.redirectGatewayURL) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Failed to initiate payment');
    }
...
const webhook = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!payload || !(payload === null || payload === void 0 ? void 0 : payload.status) || (payload === null || payload === void 0 ? void 0 : payload.status) !== 'VALID') {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'invalid Payment');
    }
    ...
    yield payment_models_1.Payment.updateOne({ tran_id }, {
        status: 'paid',
