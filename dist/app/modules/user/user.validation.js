...
exports.userValidation = exports.updateUserZodSchema = exports.createUserZodSchema = void 0;
...
const EducationSchema = zod_1.z.object({
    educationLevel: zod_1.z.string({ required_error: 'education level is required' }),
...
const updateAddressSchema = zod_1.z.object({
    ...
    district: zod_1.z.string({ required_error: 'district is required' }).optional(),
...
const updateEducationSchema = zod_1.z.object({
    ...
    degreeTitle: zod_1.z
        ...
        .optional(),
    institute: zod_1.z.string({ required_error: 'institute is required' }).optional(),
    startDate: zod_1.z.string({ required_error: 'start date is required' }).optional(),
    endDate: zod_1.z.string().optional(),
...
exports.userValidation = { createUserZodSchema: exports.createUserZodSchema, updateUserZodSchema: exports.updateUserZodSchema };
