...
const getAllUsers = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_models_1.User.find(whereCondition)
        ...
        .limit(limit);
    if (!result) {
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, 'oops! user not found.');
    }
...
const updateUser = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedUser = yield user_models_1.User.findOneAndUpdate({ _id: id }, payload, { new: true });
    if (!updatedUser) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! user update failed');
    }
    return updatedUser;
});
//block user
const blockUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const blockUser = yield user_models_1.User.findOneAndUpdate({ _id: id }, { userStatus: 'blocked' }, { new: true });
    if (!blockUser) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! user update failed');
    }
    return blockUser;
...
const deleteUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Oops! user deleting failed');
    }
    return result;
});
exports.UserService = {
