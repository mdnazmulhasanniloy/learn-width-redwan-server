...
const handelValidation_error_1 = __importDefault(
  require('../errors/handelValidation.error'),
);
const handleZod_error_1 = __importDefault(require('../errors/handleZod.error'));
const handleCast_error_1 = __importDefault(
  require('../errors/handleCast.error'),
);
...
const ErrorHandler = (error, req, res, next) => {
  ...
  if (error.name)
    if (error.name === 'ValidationError') {
      ...
      message =
        (simplifiedError === null || simplifiedError === void 0
          ? void 0
          : simplifiedError.message) || 'Validation Error';
      errorMessages =
        (simplifiedError === null || simplifiedError === void 0
          ? void 0
      ...
      message =
        (simplifiedError === null || simplifiedError === void 0
          ? void 0
          : simplifiedError.message) || 'Cast Error';
      errorMessages =
        simplifiedError === null || simplifiedError === void 0
          ? void 0
          : simplifiedError.errorMessages;
  ...
  const stack =
    (config_1.default === null || config_1.default === void 0
      ? void 0
      : config_1.default.nod_env) === 'development'
      ? error.stack
      : null;
  res.json({
    success: false,
